...
import com.ftxeven.airauctions.core.gui.action.ActionDispatcher;
import com.ftxeven.airauctions.core.gui.action.ActionParser;
...
public final class GuiManager {
    ...
    // database the embedding project supplied - core/gui has no player store of its own.
